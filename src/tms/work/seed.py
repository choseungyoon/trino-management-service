...
SEED = (
    ...
    ("W-10", TASK, "JSON API 47개 작성 (프론트 전환 1단계)",
     DONE, None, None, "docs/FRONTEND_PLAN.md"),
    ("W-11", TASK, "Vite + React 스캐폴드, FastAPI 정적 서빙 (2단계)",
     PLANNED, None, None, "docs/FRONTEND_PLAN.md"),
    ("W-12", TASK, "화면 12개를 React 로 이전 (3단계) — frontend-design 스킬 사용",
